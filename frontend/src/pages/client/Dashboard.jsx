...
const Dashboard = () => {
  ...
  // Main page tabs
  const [mainTab, setMainTab] = useState(() => sessionStorage.getItem("dashboard_mainTab") || "PROPERTIES"); // 'BRIEF' | 'PROPERTIES'
  ...
  useEffect(() => {
    sessionStorage.setItem("dashboard_mainTab", mainTab);
  }, [mainTab]);
