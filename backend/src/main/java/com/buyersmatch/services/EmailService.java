...
public class EmailService {
    ...
    private String buildClientActionHtml(String clientName, String propertyAddress, String action, String remark) {
        ...
        String actionLabel  = isAccept ? "Expressed Interest" : "Declined";
        String accentColor  = isAccept ? "#14b8a6" : "#ef4444";
        String actionEmoji  = isAccept ? "✅" : "❌";
            ...
            <body style="font-family:Arial,sans-serif;background:#f1f5f9;margin:0;padding:0;">
              <div style="max-width:600px;margin:40px auto;background:#ffffff;border-radius:16px;overflow:hidden;box-shadow:0 4px 24px rgba(0,0,0,0.08);">
                ...
                <div style="padding:40px 32px;">
                  ...
                  %s
                  <p style="color:#94a3b8;font-size:12px;text-align:center;margin:24px 0 0;">Please update the status in Zoho CRM accordingly.</p>
                </div>
              </div>
            </body>
            </html>
